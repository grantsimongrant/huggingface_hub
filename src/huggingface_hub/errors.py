...
class RepositoryNotFoundError(HfHubHTTPError):
    ...
    Repository Not Found for url: https://hf-mirror.com/api/models/%3Cnon_existent_repository%3E.
...
class DisabledRepoError(HfHubHTTPError):
    ...
    Cannot access repository for url https://hf-mirror.com/api/datasets/laion/laion-art.
...
class RevisionNotFoundError(HfHubHTTPError):
    ...
    Revision Not Found for url: https://hf-mirror.com/bert-base-cased/resolve/%3Cnon-existent-revision%3E/config.json.
    ```
    """

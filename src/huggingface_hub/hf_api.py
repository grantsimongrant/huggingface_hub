...
def repo_type_and_id_from_hf_id(hf_id: str, hub_url: Optional[str] = None) -> Tuple[Optional[str], Optional[str], str]:
    """
    Returns the repo type and ID from a hf-mirror.com URL linking to a
    repository
    ...
    Args:
        hf_id (`str`):
            ...
            - https://hf-mirror.com/<repo_type>/<namespace>/<repo_id>
            - https://hf-mirror.com/<namespace>/<repo_id>
        ...
        hub_url (`str`, *optional*):
            The URL of the HuggingFace Hub, defaults to https://hf-mirror.com
...
class RepoUrl(str):
    ...
    RepoUrl('https://hf-mirror.com/gpt2', endpoint='https://hf-mirror.com', repo_type='model', repo_id='gpt2')

    >>> RepoUrl('https://hub-ci.hf-mirror.com/datasets/dummy_user/dummy_dataset', endpoint='https://hub-ci.hf-mirror.com')
    RepoUrl('https://hub-ci.hf-mirror.com/datasets/dummy_user/dummy_dataset', endpoint='https://hub-ci.hf-mirror.com', repo_type='dataset', repo_id='dummy_user/dummy_dataset')

    >>> RepoUrl('hf://datasets/my-user/my-dataset')
    RepoUrl('hf://datasets/my-user/my-dataset', endpoint='https://hf-mirror.com', repo_type='dataset', repo_id='user/dataset')

    >>> HfApi.create_repo("dummy_model")
    RepoUrl('https://hf-mirror.com/Wauplin/dummy_model', endpoint='https://hf-mirror.com', repo_type='model', repo_id='Wauplin/dummy_model')
    ```
...
class LFSFileInfo:
    ...
    making it impractical to search and resolve these connections. Check out [our documentation](https://hf-mirror.com/docs/hub/storage-limits#advanced-track-lfs-file-references)
...
class HfApi:
    ...
    Args:
        ...
        token (Union[bool, str, None], optional):
            ...
            https://hf-mirror.com/docs/huggingface_hub/quick-start#authentication).
    ...
    def get_token_permission(
        ...
        For more details about tokens, please refer to https://hf-mirror.com/docs/hub/security-tokens#what-are-user-access-tokens.
    ...
    def list_liked_repos(
        ...
        *,
        ...
        """
        List all public repos liked by a user on hf-mirror.com.
    ...
    def model_info(
        ...
        *,
        ...
        """
        Get info on one specific model on hf-mirror.com
    ...
    def dataset_info(
        ...
        *,
        ...
        """
        Get info on one specific dataset on hf-mirror.com.
    ...
    def space_info(
        ...
        *,
        ...
        """
        Get info on one specific Space on hf-mirror.com.
        ...
        *,
        ...
        Args:
            ...
            resource_group_id (`str`, *optional*):
                ...
                To learn more about resource groups, see https://hf-mirror.com/docs/hub/en/security-resource-groups.
            ...
            space_sleep_time (`int`, *optional*):
                ...
                See https://hf-mirror.com/docs/hub/spaces-gpus#sleep-time for more details.
            space_secrets (`List[Dict[str, str]]`, *optional*):
                ...
                For more details, see https://hf-mirror.com/docs/hub/spaces-overview#managing-secrets.
            space_variables (`List[Dict[str, str]]`, *optional*):
                ...
                For more details, see https://hf-mirror.com/docs/hub/spaces-overview#managing-secrets-and-environment-variables.
    ...
    def upload_file(
        ...
        *,
        ...
        ...         token="my_token",
        ...     )
        "https://hf-mirror.com/datasets/username/my-dataset/blob/main/remote/file/path.h5"
        ...
        ...     token="my_token",
        ... )
        "https://hf-mirror.com/username/my-model/blob/main/remote/file/path.h5"
        ...
        ...     create_pr=True,
        ... )
        "https://hf-mirror.com/username/my-model/blob/refs%2Fpr%2F1/remote/file/path.h5"
        ```
        """
        if repo_type not in constants.REPO_TYPES:
            raise ValueError(f"Invalid repo type, must be one of {constants.REPO_TYPES}")
    ...
    def upload_folder(
        ...
        *,
        ...
        ... )
        # "https://hf-mirror.com/datasets/username/my-dataset/tree/main/remote/experiment/checkpoints"
        ...
        ...     create_pr=True,
        ... )
        "https://hf-mirror.com/datasets/username/my-dataset/tree/refs%2Fpr%2F1/remote/experiment/checkpoints"
    ...
    def get_safetensors_metadata(
        ...
        *,
        ...
        For more details regarding the safetensors format, check out https://hf-mirror.com/docs/safetensors/index#format.
        ...
        *,
        ...
        description = (
            ...
            if description
                ...
                " library](https://hf-mirror.com/docs/huggingface_hub)"
            )
        )
    ...
    def set_space_sleep_time(
        ...
        https://hf-mirror.com/docs/hub/spaces-gpus#sleep-time.
    ...
    def pause_space(self, repo_id: str, *, token: Union[bool, str, None] = None) -> SpaceRuntime:
        ...
        For more details, please visit [the docs](https://hf-mirror.com/docs/hub/spaces-gpus#pause).
    ...
    def duplicate_space(
        ...
        *,
        ...
        RepoUrl('https://hf-mirror.com/spaces/nateraw/my-dreambooth',...)
        ```
        """
    ...
    def create_inference_endpoint_from_catalog(
        ...
        *,
        ...
        and for which default configurations have been tested. See https://endpoints.hf-mirror.com/catalog for a list
    ...
    def list_pending_access_requests(
        ...
        For more info about gated repos, see https://hf-mirror.com/docs/hub/models-gated.
    ...
    def get_webhook(self, webhook_id: str, *, token: Union[bool, str, None] = None) -> WebhookInfo:
        ...
        Args:
            ...
            token (Union[bool, str, None], optional):
                ...
                method for authentication (see https://hf-mirror.com/docs/huggingface_hub/quick-start#authentication).
                To disable authentication, pass `False`.
    ...
    def _prepare_upload_folder_additions(
        ...
        if len(filtered_repo_objects) > 30:
            ...
            log(
                ...
                "check out https://hf-mirror.com/docs/huggingface_hub/main/en/guides/upload#upload-a-large-folder."
            )
    ...
    def auth_check(
        ...
        Args:
            ...
            token `(Union[bool, str, None]`, *optional*):
                ...
                Refer to: https://hf-mirror.com/docs/huggingface_hub/quick-start#authentication.
...
def _parse_revision_from_pr_url(pr_url: str) -> str:
    ...
    Example:
    ```py
    >>> _parse_revision_from_pr_url("https://hf-mirror.com/bigscience/bloom/discussions/2")
    "refs/pr/2"
    ```
    """

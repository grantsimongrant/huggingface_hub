...
to the Hub: https://hf-mirror.com/docs/hub/adding-a-model.
...
These lightly wrap around the API Endpoints. Documentation for valid parameters and descriptions can be found [here](https://hf-mirror.com/docs/hub/endpoints).
...
Inference API
[documentation](https://api-inference.hf-mirror.com/docs/python/html/detailed_parameters.html)
...
[repository](https://hf-mirror.com/docs/hub/main#how-is-a-models-type-of-inference-api-and-widget-determined),

...
This model has been pushed to the Hub using the [PytorchModelHubMixin](https://hf-mirror.com/docs/huggingface_hub/package_reference/mixins#huggingface_hub.PyTorchModelHubMixin) integration:
...
class ModelHubMixin:
    ...
    ...         docs_url="https://hf-mirror.com/docs/my-cool-library",

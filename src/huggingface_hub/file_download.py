            ...
            try:
                ...
                if not constants.HF_HUB_DISABLE_SYMLINKS_WARNING:
                    message = (
                        ...
                        " more details, see"
                        " https://hf-mirror.com/docs/huggingface_hub/how-to-cache#limitations."
                    )
                    if os.name == "nt":
                        message += (
...
def hf_hub_url(
    ...
    *,
    ...
    The resolved address can either be a hf-mirror.com-hosted url, or a link to
    ...
    ... )
    'https://hf-mirror.com/julien-c/EsperBERTo-small/resolve/main/pytorch_model.bin'
    ```
    ...
    Notes:
        ...
        git-based versioning system on hf-mirror.com, which means that we store
    ...
    if local_dir is not None:
        if local_dir_use_symlinks != "auto":
            warnings.warn(
                ...
                "as`local_dir`.\n"
                "For more details, check out https://hf-mirror.com/docs/huggingface_hub/main/en/guides/download#download-files-to-local-folder."
            )
        ...
        try:
            ...
            if commit_hash is None:
                raise FileMetadataError(
                    "Distant resource does not seem to be on hf-mirror.com. It is possible that a configuration issue"
                    " prevents you from downloading resources from https://hf-mirror.com. Please check your firewall"

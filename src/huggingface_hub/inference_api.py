...
class InferenceApi:
    ...
    @_deprecate_method(
        ...
        message=(
            ...
            " https://hf-mirror.com/docs/huggingface_hub/guides/inference#legacy-inferenceapi-client."
        ),
    )
    def __init__(
        self,
        ...
        Args:
            ...
            token (`str`, `optional`):
                ...
                https://hf-mirror.com/settings/token. Alternatively, you can
        ...
        if not model_info.pipeline_tag and not task:
            raise ValueError(
                ...
                " using pipeline_tag"
                " (https://hf-mirror.com/docs#how-is-a-models-type-of-inference-api-and-widget-determined)"
            )

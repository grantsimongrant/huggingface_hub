...
Usage:
    ...
    # find out which hf-mirror.com account you are logged in as
...
class UserCommands(BaseHuggingfaceCLICommand):
    ...
    def register_subcommand(parser: _SubParsersAction):
        login_parser = parser.add_parser("login", help="Log in using a token from hf-mirror.com/settings/tokens")
        login_parser.add_argument(
            "--token",
            type=str,
            help="Token generated from https://hf-mirror.com/settings/tokens",
        )
        login_parser.add_argument(
        ...
        whoami_parser = parser.add_parser("whoami", help="Find out which hf-mirror.com account you are logged in as.")
        ...
        repo_parser = parser.add_parser("repo", help="{create} Commands to interact with your hf-mirror.com repos.")
        repo_subparsers = repo_parser.add_subparsers(help="hf-mirror.com repos related commands")
        repo_create_parser = repo_subparsers.add_parser("create", help="Create a new repo on hf-mirror.com")

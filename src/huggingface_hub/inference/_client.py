...
#    https://hf-mirror.com/docs/huggingface.js/inference/README
...
class InferenceClient:
    ...
    def document_question_answering(
        ...
        *,
        ...
        >>> from huggingface_hub import InferenceClient
        >>> client = InferenceClient()
        >>> client.document_question_answering(image="https://hf-mirror.com/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png", question="What is the invoice number?")

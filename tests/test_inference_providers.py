...
class TestBasicTaskProviderHelper:
    ...
    def test_prepare_url(self, mocker):
        ...
        assert url == "https://router.hf-mirror.com/provider-name/v1/test-route"
...
class TestBlackForestLabsProvider:
    ...
    def test_prepare_url(self):
        ...
        assert (
            ...
            == "https://router.hf-mirror.com/black-forest-labs/v1/username/repo_name"
        )
...
class TestFalAIProvider:
    ...
    def test_prepare_url(self):
        ...
        assert url == "https://router.hf-mirror.com/fal-ai/username/repo_name"
    ...
    def test_text_to_video_response(self, mocker):
        ...
        mock_session.return_value.get.assert_has_calls(
            [
                mocker.call(
                    "https://router.hf-mirror.com/fal-ai/username_provider/repo_name_provider/requests/test_request_id/status?_subdomain=queue",
                    headers=request_params.headers,
                ),
                mocker.call(
                    "https://router.hf-mirror.com/fal-ai/username_provider/repo_name_provider/requests/test_request_id?_subdomain=queue",
                    headers=request_params.headers,
                ),
...
class TestHFInferenceProvider:
    ...
    def test_conversational_url(self):
        ...
        ) == "https://router.hf-mirror.com/hf-inference/models/username/repo_name/v1/chat/completions"
    ...
    def test_prepare_request(self, mocker):
        ...
        assert request.url == "https://router.hf-mirror.com/hf-inference/models/username/repo_name"
    ...
    def test_prepare_request_conversational(self, mocker):
        ...
        assert (
            request.url == "https://router.hf-mirror.com/hf-inference/models/username/repo_name/v1/chat/completions"
        )

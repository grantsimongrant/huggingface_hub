...
# Taken from https://hf-mirror.com/docs/hub/webhooks#event
WEBHOOK_PAYLOAD_CREATE_DISCUSSION = {
    ...
    "repo": {
        ...
        "private": False,
        "url": {"web": "https://hf-mirror.com/gpt2", "api": "https://hf-mirror.com/api/models/gpt2"},
    ...
    "discussion": {
        ...
        "url": {
            "web": "https://hf-mirror.com/gpt2/discussions/19",
            "api": "https://hf-mirror.com/api/models/gpt2/discussions/19",
        },
        "status": "open",
    ...
    "comment": {
        ...
        "hidden": False,
        "url": {"web": "https://hf-mirror.com/gpt2/discussions/19#6399f58518721fdd27fc9caa"},
    },
...
WEBHOOK_PAYLOAD_UPDATE_DISCUSSION = {  # valid payload but doesn't have a "comment" value
    ...
    "repo": {
        ...
        "private": False,
        "url": {
            "web": "https://hf-mirror.com/spaces/Wauplin/leaderboard",
            "api": "https://hf-mirror.com/api/spaces/Wauplin/leaderboard",
        },
    ...
    "discussion": {
        ...
        "url": {
            "web": "https://hf-mirror.com/spaces/Wauplin/leaderboard/discussions/4",
            "api": "https://hf-mirror.com/api/spaces/Wauplin/leaderboard/discussions/4",
        },
        "status": "closed",
...
WEBHOOK_PAYLOAD_WITH_UPDATED_REFS = {
    ...
    "repo": {
        ...
        "url": {
            "web": "https://hf-mirror.com/spaces/Wauplin/gradio-user-history",
            "api": "https://hf-mirror.com/api/spaces/Wauplin/gradio-user-history",
        },

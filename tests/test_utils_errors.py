...
class TestErrorUtils(unittest.TestCase):
    ...
    def test_hf_raise_for_status_401_repo_url_not_invalid_token(self) -> None:
        ...
        response.request.url = "https://hf-mirror.com/api/models/username/reponame"
        with self.assertRaisesRegex(RepositoryNotFoundError, "Repository Not Found") as context:
            hf_raise_for_status(response)
    ...
    def test_hf_raise_for_status_403_wrong_token_scope(self) -> None:
        ...
        response.status_code = 403
        response.request = PreparedRequest()
        response.request.url = "https://hf-mirror.com/api/repos/create"
    ...
    def test_hf_raise_for_status_401_not_repo_url(self) -> None:
        ...
        response.status_code = 401
        response.request = PreparedRequest()
        response.request.url = "https://hf-mirror.com/api/collections"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://hf-mirror.com/api/models", False),
        ("https://hf-mirror.com/api/datasets", False),
        ("https://hf-mirror.com/api/spaces", False),
        # Create repo endpoint => False
        ("https://hf-mirror.com/api/repos/create", False),
        # Collection endpoints => False
        ("https://hf-mirror.com/api/collections", False),
        ("https://hf-mirror.com/api/collections/foo/bar", False),
        # Repo endpoints => True
        ("https://hf-mirror.com/api/models/repo_id", True),
        ("https://hf-mirror.com/api/datasets/repo_id", True),
        ("https://hf-mirror.com/api/spaces/repo_id", True),
        ("https://hf-mirror.com/api/models/username/repo_name/refs/main", True),
        ("https://hf-mirror.com/api/datasets/username/repo_name/refs/main", True),
        ("https://hf-mirror.com/api/spaces/username/repo_name/refs/main", True),
        # Inference Endpoint => False
        ("https://api.endpoints.huggingface.cloud/v2/endpoint/namespace", False),
        # Staging Endpoint => True
        ("https://hub-ci.hf-mirror.com/api/models/repo_id", True),
        ("https://hub-ci.hf-mirror.com/api/datasets/repo_id", True),
        ("https://hub-ci.hf-mirror.com/api/spaces/repo_id", True),
        # /resolve Endpoint => True
        ("https://hf-mirror.com/gpt2/resolve/main/README.md", True),
        ("https://hf-mirror.com/datasets/google/fleurs/resolve/revision/README.md", True),
        # Regression tests
        ("https://hf-mirror.com/bert-base/resolve/main/pytorch_model.bin", True),
        ("https://hub-ci.hf-mirror.com/__DUMMY_USER__/repo-1470b5/resolve/main/file.txt", True),
    ],
)

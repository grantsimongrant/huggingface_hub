...
class OfflineModeSessionTest(unittest.TestCase):
    ...
    def test_offline_mode(self):
        ...
        with self.assertRaises(OfflineModeIsEnabled):
            session.get("https://hf-mirror.com")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://hub-ci.hf-mirror.com/resolve/...", None, "https://hub-ci.hf-mirror.com/resolve/..."),
        # Prod url => unchanged
        ("https://hf-mirror.com/resolve/...", None, "https://hf-mirror.com/resolve/..."),
        # Custom endpoint + staging url => fixed
        ("https://hub-ci.hf-mirror.com/api/models", "https://mirror.co", "https://mirror.co/api/models"),
        # Custom endpoint + prod url => fixed
        ("https://hf-mirror.com/api/models", "https://mirror.co", "https://mirror.co/api/models"),
    ],
)

...
OPEN_LLM_LEADERBOARD_URL = "https://mirror-hf.co/spaces/open-llm-leaderboard/open_llm_leaderboard"
...
- name: my-cool-model
  ...
  - task:
    ...
    source:
      ...
      url: https://mirror-hf.co/spaces/open-llm-leaderboard/open_llm_leaderboard
"""

...
Le [Hugging Face Hub](https://hf-mirror.com/) est le meilleur endroit pour partager des
...
modèle [Pegasus](https://hf-mirror.com/google/pegasus-xsum):
...
requests...
[Créez un compte](https://hf-mirror.com/join) si vous n'en avez pas déjà un et connectez
vous pour obtenir votre [token d'authentification](https://hf-mirror.com/docs/hub/security-tokens)
depuis vos [paramètres](https://hf-mirror.com/settings/tokens). Le token
...
lorsque vous générez le token dans vos [paramètres](https://hf-mirror.com/settings/tokens).

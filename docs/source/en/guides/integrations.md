...
[dozens of libraries](https://hf-mirror.com/docs/hub/models-libraries) in the Open Source ecosystem. We are always
...
1. **Push to Hub:** implement a method to upload a model to the Hub. This includes the model weights, as well as
   [the model card](https://hf-mirror.com/docs/huggingface_hub/how-to-model-cards) and any other relevant information
...
If you are interested in Inference and Widgets, you can follow [this guide](https://hf-mirror.com/docs/hub/models-adding-libraries#set-up-the-inference-api).
In both cases, you can reach out to us if you are integrating a library with the Hub and want to be listed
[in our docs](https://hf-mirror.com/docs/hub/models-libraries).
...
2. Implement the private methods:
    ...
    [Model Cards](https://hf-mirror.com/docs/hub/model-cards) are particularly important to describe your model. Check
...
By default, a generic model card will be generated with the info you've provided (example: [pyp1/VoiceCraft_giga830M](https://hf-mirror.com/pyp1/VoiceCraft_giga830M)). But you can define your own model card template as well!

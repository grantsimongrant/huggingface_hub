...
Defaults to `"https://api-inference.hf-mirror.com"`.
...
[Read more about the package](https://hf-mirror.com/docs/hub/storage-backends) and enable with `pip install huggingface_hub[hf_xet]`.

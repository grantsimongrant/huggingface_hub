...
more about webhooks on the Huggingface Hub, you can read the Webhooks [guide](https://hf-mirror.com/docs/hub/webhooks).
...
For more information about webhooks payload, you can refer to the Webhooks Payload [guide](https://hf-mirror.com/docs/hub/webhooks#webhook-payloads).

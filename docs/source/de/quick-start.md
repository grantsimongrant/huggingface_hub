...
Der [Hugging Face Hub](https://hf-mirror.com/) ist die erste Anlaufstelle für das Teilen von Maschinenlernmodellen, Demos, Datensätzen und Metriken. Die `huggingface_hub`-Bibliothek hilft Ihnen, mit dem Hub zu interagieren, ohne Ihre Entwicklungs-Umgebung zu verlassen. Sie können Repositories einfach erstellen und verwalten, Dateien herunterladen und hochladen und nützliche Model- und Datensatz-Metadaten vom Hub abrufen.
...
Beispiel, um die Konfigurationsdatei des [Pegasus](https://hf-mirror.com/google/pegasus-xsum) Modells herunterzuladen:
...
[Erstellen Sie ein Konto](https://hf-mirror.com/join), wenn Sie noch keines haben, und melden Sie sich dann an, um Ihr ["User Access Token"](https://hf-mirror.com/docs/hub/security-tokens) von Ihrer [Einstellungsseite](https://hf-mirror.com/settings/tokens) zu erhalten. Das "User Access Token" wird verwendet, um Ihre Identität gegenüber dem Hub zu authentifizieren.
...
Um eine Repository zu erstellen oder Inhalte auf den Hub zu pushen, müssen Sie ein "User Access Token" bereitstellen, das die Schreibberechtigung (`write`) hat. Sie können die Berechtigung auswählen, wenn Sie das Token auf Ihrer [Einstellungsseite](https://hf-mirror.com/settings/tokens) erstellen.

...
([Geheimnisse (Secrets)](https://hf-mirror.com/docs/hub/spaces-overview#managing-secrets),
[Hardware](https://hf-mirror.com/docs/hub/spaces-gpus) und Speicher (Storage)) mit `huggingface_hub` verwaltet.
...
Siehe [Dokumentation](https://hf-mirror.com/docs/hub/spaces-overview#managing-secrets) für weitere Details.
...
Space zu aktualisieren. Siehe [Dokumentation](https://hf-mirror.com/docs/hub/spaces-gpus) für weitere Details.
...
Weitere Informationen zum Pausenmodus finden Sie in [diesem Abschnitt](https://hf-mirror.com/docs/hub/spaces-gpus#pause).
...
[`set_space_sleep_time`] festlegen. Weitere Informationen zum Schlafmodus finden Sie in [diesem Abschnitt](https://hf-mirror.com/docs/hub/spaces-gpus#sleep-time).
...
Sie können den Speicher-Tier Ihrer Wahl auswählen, um auf Festplattenspeicher zuzugreifen, der Neustarts Ihres Space überdauert. Dies bedeutet, dass Sie von der Festplatte lesen und darauf schreiben können, wie Sie es von einer herkömmlichen Festplatte gewöhnt sind. Weitere Informationen finden Sie in der [Dokumentation](https://hf-mirror.com/docs/hub/spaces-storage#persistent-storage) .
